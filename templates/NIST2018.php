...
set_config('simple_length_input', 10, 'tool_password');
set_config('complex_length_input', 13, 'tool_password');
set_config('irap_numbers', 1, 'tool_password');
set_config('sequential_digits', 0, 'tool_password');
set_config('sequential_digits_input', 2, 'tool_password');
set_config('repeated_chars', 0, 'tool_password');
...
set_config('time_lockout', 0, 'tool_password');
