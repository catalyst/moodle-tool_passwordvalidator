...
set_config('simple_length_input', 8, 'tool_password');
set_config('complex_length_input', 8, 'tool_password');
set_config('irap_numbers', 0, 'tool_password');
set_config('sequential_digits_input', 0, 'tool_password');
set_config('repeated_chars_input', 0, 'tool_password');
